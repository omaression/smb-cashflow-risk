...
- [x] Create separate project repo under `projects/`
- [x] Write project README
- [x] Write blueprint
- [x] Define domain model
- [x] Create initial SQL schema
- [x] Create sample CSV formats
- [x] Create project-specific production checklist
- [x] Draft v0 API contract
